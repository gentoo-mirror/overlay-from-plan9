...
inherit git-r3
EGIT_REPO_URI="https://github.com/matrix-org/pantalaimon"
...
RDEPEND="
	...
	>=dev-python/matrix-nio-0.23.0[e2e(+),${PYTHON_USEDEP}]
...
src_install() {
	...
	install -Dm755 "${FILESDIR}/pantalaimon-openrc" "${D}/etc/init.d/pantalaimon"
}
